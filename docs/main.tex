...
\begin{figure}[h!]
\centering
\includegraphics[width=1.0\textwidth]{redshift_hist.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.8\textwidth]{best_dtree.png}
...
Izbor vrednosti 'k' igra ključnu ulogu u performansama KNN modela. Klasifikator sa malim brojem suseda odgovara visokoj složenosti modela što može dovesti do preprilagođavanja i verovatno će loše raditi na test skupu podataka. Sa druge strane, model sa mnogo suseda odgovara niskoj složenosti modela. Slično kao i kod prethodnih modela, za traženje najboljeg skupa hiperparametara koristili smo pretragu u kombinaciji sa unakrsnom validacijom.
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.8\textwidth]{gaussian_nb_classification_report.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.8\textwidth]{gaussian_nb_cm.png}
